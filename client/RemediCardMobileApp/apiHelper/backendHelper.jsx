...
export const updateFlashcard = async (id, data, onUploadProgress) => {
  return await putFetcher(url.UPDATE_FLASHCARD_PATH(id), data, "multipart/form-data", onUploadProgress);
};
...
export const autoGenerateDeck = async (formData, onUploadProgress) => {
  return await postFetcher(
...
export const autoGenerateQuiz = async (formData, onUploadProgress) => {
  return await postFetcher(
