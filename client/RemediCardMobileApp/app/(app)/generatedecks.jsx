...
export default function GenerateDecks() {
  ...
  const handleGenerate = async () => {
    ...
    actualFormData.append("file", {
      uri: file.uri,
      type: "application/multipart",
      name: file.name,
    });

    actualFormData.append("dataType", "VOICE_RECORD");
    actualFormData.append("language", "ENGLISH");
    ...
    /* axios
      .post(`${BASE_URL}/auto_generation/generate`, actualFormData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: token,
        },
    ...
    autoGenerateDeck(actualFormData)
      .then((res) => {
        setFile(null);
        setFileType(null);
