...
export default function StudyDashboard() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Suggestion Box 1 */}
      <TouchableOpacity style={[styles.suggestionBox, styles.blueBox]}>
        <Link href="/(app)/deck-details" style={styles.suggestionLink}>
          <View>
            <Text style={styles.suggestionTitle}>What about exercicing Deck 1 ?</Text>
      ...
      <TouchableOpacity style={[styles.suggestionBox, styles.blueBox]}>
        <Link href="/(app)/deck-details" style={styles.suggestionLink}>
          <View>
            <Text style={styles.suggestionTitle}>What about exercicing Deck 2 ?</Text>
            <Text style={styles.suggestionSubtitle}>
